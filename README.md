...
6. Начинайте разработку. Можете менять уже существующие настройки, но я постарался сделать их максимально стандартными и рабочими для всех.

7. Для обновления шаблона используйте соответствующую команду из command pallet -> run task.

8. При изменениях в .devcontainer: command pallet -> rebuild container.
